...
Screenshots
<!-- Add screenshots before submission, e.g.: --> <!-- ![Landing Page](./screenshots/landing.png) --> <!-- ![Dashboard](./screenshots/dashboard.png) --> <!-- ![Registration Flow](./screenshots/registration.png) --> <!-- ![Concurrency Conflict Handling](./screenshots/conflict-retry.png) -->
